<template>
    <Layout>
        <div
            ...
            <span class="text-xl block text-left ml-0">Jucatori</span>
        </div>
        <form @submit.prevent="submit">
            <div class="grid gap-6 mb-6 md:grid-cols-2">
                ...
                <div class="mb-6">
                    <label for="age" class="block mb-2 text-sm font-medium text-gray-900 ">Vârstă</label>
            ...
            <div class="grid gap-6 mb-6 md:grid-cols-2">
                <div class="mb-6">
                    <label for="height" class="block mb-2 text-sm font-medium text-gray-900 ">Înălțime</label>
                    <input type="text" id="height" v-model="form.height"
                        class=" border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5  dark:border-gray-600 dark:placeholder-gray-400  dark:focus:ring-blue-500 dark:focus:border-blue-500"
                        placeholder="150cm" required>
                </div>
                <div class="mb-6">
                    <label for="weight" class="block mb-2 text-sm font-medium text-gray-900 ">Greutate</label>
                    <input type="text" id="weight" v-model="form.weight"
                        class=" border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5  dark:border-gray-600 dark:placeholder-gray-400  dark:focus:ring-blue-500 dark:focus:border-blue-500"
                        placeholder="50kg" required>
                </div>
            </div>
            <div class="mb-6">
                <label for="position" class="block mb-2 text-sm font-medium text-gray-900 ">Poziție</label>
            ...
            <div class="mb-6">
                <label for="password" class="block mb-2 text-sm font-medium text-gray-900 ">Parola</label>
                <input type="password" id="password" v-model="form.password"
                    class=" border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5  dark:border-gray-600 dark:placeholder-gray-400  dark:focus:ring-blue-500 dark:focus:border-blue-500"
                    placeholder="•••••••••" required>
            </div>
            <div class="mb-6">
                <label for="confirm_password" class="block mb-2 text-sm font-medium text-gray-900 ">Confirmă
                    parola</label>
...
export default {
    ...
    methods: {
        submit() {
            this.$inertia.post(route('players.store'), this.form)
        }
    }
}
