            ...
            <dd class="flex justify-end mt-1 flex text-md leading-6 text-gray-700 sm:col-span-2 sm:mt-0">
                <span class="ml-4 flex-shrink-0">
                    <template v-if="editing">
                        <button @click="toggleEdit, open = true"
                            ...
                            <DialogPanel
                                ...
                                <div class="mt-5 sm:mt-6">
                                    <button
                                        ...
                                        @click="save">Go back to dashboard</button>
                                </div>
                            </DialogPanel>
                        </TransitionChild>
                    </div>
            ...
            if (!this.editing) {
                ...
                if (changesDetected) {
                    ...
                    const updatedPlayerData = {
                        first_name: this.form.editedFirstName,
                        last_name: this.form.editedLastName,
                        date_of_birth: this.form.editedDateOfBirth,
                        player_group: this.form.editedPlayerGroup,
                        skill_level: this.form.editedSkillLevel,
                        height: this.form.editedHeight,
                        weight: this.form.editedWeight,
                        parent_name: this.form.editedParentName,
                        parent_phone: this.form.editedParentPhoneNumber,
                    };

                    this.open = false;
                    this.$inertia.put(route('admin.dashboard.players.update', this.player), updatedPlayerData);
                }
            }
        },
    },
