                    ...
                    <form @submit.prevent="submit" class="w-full">
                        <div class="flex flex-col gap-7 justify-start">
                            <div class="flex flex-col gap-2">
                                <h1 class="title max-w-max">Recuperează-ți parola</h1>
                                <span class="text-gray-500">Ți-ai uitat parola? Nicio grijă, se mai întâmplă.
                                    😄</span>
                            </div>
                            ...
                            <div class="flex flex-col gap-1">
                                <span>Introdu adresa de email</span>
                                <input type="email" class="input bg-white rounded-md text-black px-2 py-1"
                                    placeholder="Email" v-model="form.email" />
                            </div>
                            <button type="submit"
                                class="button bg-gradient-to-br from-blue-400 to-blue-600 !max-w-full font-bold hover:from-blue-500 hover:to-blue-700">Trimite
                                cod de resetare</button>
                            <inertia-link :href="route('auth.login')" class="flex justify-center">
                                <span class="text-gray-500">Înapoi la autentificare</span>
                            </inertia-link>
                        </div>
                    </form>
                </div>
