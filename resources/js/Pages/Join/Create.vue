                ...
                <div class="px-6 lg:px-8">
                    <div class="mx-auto max-w-xl lg:mx-0 lg:max-w-lg">
                        ...
                        <p class="mt-2 text-lg leading-8 text-gray-600">Vino alături de noi pentru a construi viitorul
                            baschetului. Oferim oportunități incredibile pentru dezvoltare și succes. Hai să facem
                            echipă și să
                            ...
                            <div class="grid grid-cols-1 gap-x-8 gap-y-6 sm:grid-cols-2">
                                <div>
                                    <label for="first-name"
                                        class="block text-sm font-semibold leading-6 text-gray-900">Nume
                                    </label>
                                    <div class="mt-2.5">
                                ...
                                <div>
                                    <label for="last-name"
                                        class="block text-sm font-semibold leading-6 text-gray-900">Prenume
                                    </label>
                                    <div class="mt-2.5">
                                ...
                                <div class="sm:col-span-2">
                                    <label for="date_of_birth"
                                        class="block text-sm font-semibold leading-6 text-gray-900">Data
                                        nasterii</label>
                                    <div class="mt-2.5">
                                        <input type="date" name="date_of_birth" id="date_of_birth"
                                            autocomplete="given-name" v-model="form.date_of_birth"
                                            :class="{ 'border-red-500': errors.date_of_birth }"
                                            class="block w-full rounded-md border-0 px-3.5 py-2 text-gray-900 shadow-sm ring-1 ring-inset ring-gray-300 placeholder:text-gray-400 focus:ring-2 focus:ring-inset focus:ring-indigo-600 sm:text-sm sm:leading-6" />
                                        <span v-if="errors.date_of_birth" class="text-red-500 text-sm">{{
                    errors.date_of_birth
                                ...
                                <div class="sm:col-span-2">
                                    <div class="flex justify-between text-sm leading-6">
                                        <label for="phone" class="block font-semibold text-gray-900">Număr de telefon
                                            parinte</label>
                                    ...
                                    <div class="flex justify-between text-sm leading-6">
                                        <label for="parent_name" class="block font-semibold text-gray-900">Nume
                                            parinte</label>
                                        <!-- <p id="phone-description" class="text-gray-400">Optional</p> -->
                                    </div>
                                    <div class="mt-2.5">
                                        <input type="text" name="parent_name" id="parent_name" autocomplete="given-name"
                                            ...
                                            class="block w-full rounded-md border-0 px-3.5 py-2 text-gray-900 shadow-sm ring-1 ring-inset ring-gray-300 placeholder:text-gray-400 focus:ring-2 focus:ring-inset focus:ring-indigo-600 sm:text-sm sm:leading-6" />
                                        <span v-if="errors.parent_name" class="text-red-500 text-sm">{{
                    errors.parent_name
                }}</span>
                                    </div>
                                </div>
                                <div class="sm:col-span-2">
                                    <div class="flex justify-between text-sm leading-6">
                                        <label for="message"
                                            class="block text-sm font-semibold leading-6 text-gray-900">Lasă-ne
                                            un mesaj</label>
                                        <p id="message-description" class="text-gray-400">Max 500 characters</p>
                                    </div>
                                    <div class="mt-2.5">
                                        <textarea id="message" name="message" rows="4"
                                            aria-describedby="message-description" v-model="form.message"
                                            class="block w-full rounded-md border-0 px-3.5 py-2 text-gray-900 shadow-sm ring-1 ring-inset ring-gray-300 placeholder:text-gray-400 focus:ring-2 focus:ring-inset focus:ring-indigo-600 sm:text-sm sm:leading-6" />
                                    </div>
                                </div>
                            </div>
