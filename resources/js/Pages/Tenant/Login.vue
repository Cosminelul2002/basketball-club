                        ...
                        <div class="flex flex-col gap-7">
                            ...
                            <div class="flex flex-col gap-1">
                                <button type="button" @click="googleAuth"
                                    class="button bg-gradient-to-br from-red-400 to-red-600 !max-w-full font-bold hover:from-red-500 hover:to-red-700">
                                    <svg class="w-6 h-6" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                                        <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2"
                                            d="M12 6v3m0 9v3m-6-3h3m9 0h3m-9-12H6m12 0h3"></path>
                                    </svg>
                                    Intră cu Google
                                </button>
                            </div>
                            ...
                            <inertia-link :href="route('auth.register')"
                                class="flex justify-center text-gray-500 text-md">
...
export default {
    ...
    methods: {
        ...
        googleAuth() {
            this.$inertia.get(route('google.redirect'));
        }
    }
